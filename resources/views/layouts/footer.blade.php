      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="mt-4 flex sm:mt-0 sm:justify-center">
              ...
              <a href="#" class="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
              ...
              <a href="#" class="ms-5 text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
...
<div class="flex min-h-screen flex-col">
    ...
    <footer class="bg-[#0a1a2b] py-12 text-white">
        <div class="container mx-auto px-4">
            <div class="mb-10 text-center">
                <h2 class="mb-4 text-xl font-bold">Our Solutions</h2>
                <div class="flex flex-wrap justify-center space-x-4 lg:space-x-8">
                </div>
            </div>

            <div class="mb-8 border-t border-gray-600"></div>

            <div class="grid grid-cols-1 gap-8 text-center sm:grid-cols-2 md:grid-cols-4 md:text-left">


                <div>
                    <h3 class="mb-4 text-lg font-semibold">GP3</h3>
                    <ul class="space-y-2">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="hover:underline">Research Reports</a></li>
                ...
                <div>
                    <h3 class="mb-1 text-lg font-semibold">GP3 Solution</h3>
                    <div class="flex justify-start space-x-4 md:justify-center">
                        <a href="#" class="hover:text-gray-400">
                            <img src="/img/footer/icon-instagram.png" alt="Instagram" class="h-6 w-6">
                        </a>
                        <a href="#" class="hover:text-gray-400">
                            <img src="/img/footer/icon-tiktok.png" alt="TikTok" class="h-6 w-6">
                        </a>
                        <a href="#" class="hover:text-gray-400">
                            <img src="/img/footer/icon-linkedin.png" alt="LinkedIn" class="h-6 w-6">
                        </a>
                        <a href="#" class="hover:text-gray-400">
                            <img src="/img/footer/icon-youtube.png" alt="YouTube" class="h-6 w-6">
                        </a>
                        <a href="#" class="hover:text-gray-400">
                            <img src="/img/footer/icon-facebook.png" alt="Facebook" class="h-6 w-6">
                        </a>
                    </div>

                    <br>

                    <h3 class="mb-1 text-lg font-semibold">Inside GP3</h3>
            ...
            <div class="flex flex-col items-center justify-between text-sm md:flex-row">
                <p class="mb-2 md:mb-0">© 2024 GP3</p>
                <p>by GP3</p>
            </div>
        </div>
    </footer>
