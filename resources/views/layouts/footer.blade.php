...
<div class="flex flex-col min-h-screen">
    ...
    <footer class="bg-[#0a1a2b] text-white py-12">
        <div class="container px-4 mx-auto">
            <div class="mb-10 text-center">
                ...
                <div class="flex flex-wrap justify-center space-x-4 lg:space-x-8">
                    <a href="#" class="flex items-center mb-4 hover:underline lg:mb-0">
                        SIRCLO Commerce <span class="ml-2">→</span>
                    </a>
                    <a href="#" class="flex items-center mb-4 hover:underline lg:mb-0">
                        SIRCLO SWIFT <span class="ml-2">→</span>
                    </a>
                    <a href="#" class="flex items-center mb-4 hover:underline lg:mb-0">
                        SIRCLO StreamLab <span class="ml-2">→</span>
                    </a>
                    <a href="#" class="flex items-center mb-4 hover:underline lg:mb-0">
                        SWIFT Hub <span class="ml-2">→</span>
                    </a>
                    <a href="#" class="flex items-center mb-4 hover:underline lg:mb-0">
                        Warung Pintar <span class="ml-2">→</span>
                    </a>
                    <a href="#" class="flex items-center mb-4 hover:underline lg:mb-0">
                        Orami <span class="ml-2">→</span>
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-8 text-center sm:grid-cols-2 md:grid-cols-4 md:text-left">
                ...
                <div>
                    <h3 class="mb-4 text-lg font-semibold">SIRCLO</h3>
                    <ul class="space-y-2">
                ...
                <div>
                    <h3 class="mb-1 text-lg font-semibold">SIRCLO Solution</h3>
                    ...
                    <h3 class="mb-1 text-lg font-semibold">Inside SIRCLO</h3>
            ...
            <div class="flex flex-col items-center justify-between text-sm md:flex-row">
                <p class="mb-2 md:mb-0">© 2024 SIRCLO</p>
                <p>by SIRCLO</p>
            </div>
        </div>
    </footer>
